...
export default function Home() {
  ...
  function handleCautare() {
    getProduse(cautare)
  }

  function handleKeyDown(e: any) {
    if (e.key === 'Enter') handleCautare()
  }
          ...
          {produse.map((produs: any) => {
            ...
            return (
              <div key={produs.id} style={{background: '#fff', border: '1px solid #eee', borderRadius: '12px', padding: '14px'}}>
                <div style={{width: '100%', height: '80px', background: '#E1F5EE', borderRadius: '8px', marginBottom: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '24px'}}>
                  💊
                </div>
